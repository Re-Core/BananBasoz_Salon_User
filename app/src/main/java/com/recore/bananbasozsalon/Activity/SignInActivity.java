...
public class SignInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        codeContainer = (TextInputLayout) findViewById(R.id.codeLoginContainer);

        mAuth = FirebaseAuth.getInstance();

        main_layout = (ConstraintLayout) findViewById(R.id.main_login_layout);

        edtPhoneNumber = (TextInputEditText) findViewById(R.id.edtLoginPhone);
        edtVerificationCode = (TextInputEditText) findViewById(R.id.edtLoginValidationCode);


        btnSignin = (Button) findViewById(R.id.btnLoginSentCode);
        btnVerify = (Button) findViewById(R.id.btnLoginValidateCode);
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationCompleted(PhoneAuthCredential credential) {
                ...
                Toast.makeText(SignInActivity.this, "Verification Complete", Toast.LENGTH_SHORT).show();
...
//                    edtPhoneNumber.setError(getResources().getString(R.string.invalid_phone),getDrawable(R.drawable.ic_error_outline_black_24dp));
            ...
            public void onCodeSent(String verificationId,
                ...
                waitingDialog.dismiss();
                Toast.makeText(SignInActivity.this, "Verification code has been send on your number", Toast.LENGTH_SHORT).show();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isComplete()) {
                            ...
                            userRef.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    if (dataSnapshot.child(userPhone).exists()) {
                                        ...
                                        Snackbar.make(main_layout, "User does not exist", Snackbar.LENGTH_LONG).show();
                                        waitingDialog.dismiss();
                                    }
                                }
                            ...
                            Toast.makeText(SignInActivity.this, "Verification Done", Toast.LENGTH_SHORT).show();
                            // ...
                        } else {
